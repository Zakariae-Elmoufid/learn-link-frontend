...
export const messageKeys = {
    ...
    unreadCountConversation: (userId: number) => [...messageKeys.all, 'unread', userId] as const,
}
...
export function useSendMessage() {
    ...
    return useMutation({
        ...
        onSuccess: (message) => {
            ...
            queryClient.invalidateQueries({ queryKey: messageKeys.conversation(message.recipientId) })
        },
        onError: (error: any) => {
...
export function useMarkConversationAsRead() {
    ...
    return useMutation({
        mutationFn: (senderId: number) => messageService.markConversationAsRead(senderId),
...
export function useDeleteConversation() {
    ...
    return useMutation({
        mutationFn: (otherUserId: number) => messageService.deleteConversation(otherUserId),
        onSuccess: () => {
