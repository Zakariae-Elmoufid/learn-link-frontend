...
const mainNavItems: NavItem[] = [
    ...
    { label: 'Courses', href: '/dashboard/courses', icon: <BookOpen className="h-5 w-5" /> },
    { label: 'Study Groups', href: '/dashboard/groups', icon: <Users className="h-5 w-5" /> },
    { label: 'Messages', href: '/dashboard/messages', icon: <MessageSquare className="h-5 w-5" /> },
    { label: 'Schedule', href: '/dashboard/schedule', icon: <Calendar className="h-5 w-5" /> },
    { label: 'Achievements', href: '/dashboard/achievements', icon: <Award className="h-5 w-5" /> },
]
